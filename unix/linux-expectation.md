...
* Monolithic software that does everything, rather than composing multiple tools together where each does its own thing very well
* Differences in filesystem, graphical environments and more
* Registry editor instead of dotfiles and pseudo-files
* And more
